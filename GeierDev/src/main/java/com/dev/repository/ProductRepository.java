...
public interface ProductRepository extends JpaRepository<Product, Long> {
	...
	@Query("SELECT p FROM Product p WHERE p.name LIKE %?1% AND p.brand LIKE %?2% AND p.price BETWEEN ?3 AND ?4")
	public List<Product> searchAll(String keyword, String keyword1,Float keyword2,Float keyword3);
    ...
    public List<Product> searchNombres(String keyword,String keyword1);
